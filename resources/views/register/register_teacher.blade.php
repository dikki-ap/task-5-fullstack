  ...
  <body>
            ...
            <div class="col-lg-5">
                <div class="card rounded-3 shadow p-3">
                    ...
                    <div class="card-body">
                      ...
                      <form action="/register/teacher" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- Name --}}
                        ...
                        <div class="form-floating">
                            ...
                            {{-- Buat Tag Untuk Preview Image --}}
                            <img class="img-preview img-fluid mb-3 col-sm-5 mt-2">
                        </div>
                    
                        <button class="w-100 btn btn-lg btn-primary border-0 mt-3" type="submit" style="background-color: #99A799"><span data-feather="user-plus"></span>&nbsp; Register</button>
                    </form>
                    <small class="d-block text-center mt-3">Sudah registrasi? <a href="/login/teacher" class="text-decoration-none" style="color: #99A799">Login Sekarang!</a></small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function previewImage(){
            ...
            // Mengambil data gambar yang di upload
