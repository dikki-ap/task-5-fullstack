        ...
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="card rounded-3 shadow p-3">
                    ...
                    {{-- <small class="d-block text-center mt-3">Belum registrasi? <a href="/register/teacher" class="text-decoration-none" style="color: #99A799">Registrasi Sekarang!</a></small> --}}
                    </div>
                </div>
            </div>
        </div>
